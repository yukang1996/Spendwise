...
//            Log.d(TAG, "input auto digit: "+autoDecimalDigits);
            ...
            if (rounded_value > 999){
                rounded_value/=1000;
                temp = String.valueOf(rounded_value) + "k";

            } else if (rounded_value > 99999){
                rounded_value /= 100000;
                temp = String.valueOf(rounded_value) + "0k";
            } else {
                temp = String.valueOf(rounded_value);
            }
